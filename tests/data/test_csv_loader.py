...
5.0,6.0
7.0,8.0"""
    params = _determine_csv_parameters(csv_content)
...
7.0,8.0"""
    ...
    data, report = load_csv(str(csv_file), na_policy='remove')
    ...
    data, report = load_csv(str(csv_file), na_policy='abort')
