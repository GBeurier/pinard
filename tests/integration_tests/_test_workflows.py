...
#         configs = [
#             Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, nicon, bacon_train_short, seed),
#             Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, model_sklearn, None, seed),
#             Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, tf_model, bacon_train_short, seed),
#             Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, torch_model, bacon_train_short, seed)
#         ]
...
#     configs = [
#         Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, nicon, bacon_train_short, seed),
#         Config("sample_data/WhiskyConcentration", x_pipeline_full, y_pipeline, nicon, bacon_train_short, seed),
#         Config("sample_data/WhiskyConcentration", x_pipelineb, y_pipeline, nicon, bacon_train_short, seed)
#     ]
...
#             # Regression tasks
#             Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, nicon, bacon_train_short, seed),
#             Config("sample_data/WhiskyConcentration", x_pipeline_full, y_pipeline, tf_model, bacon_train_short, seed),
#             Config("sample_data/WhiskyConcentration", x_pipelineb, y_pipeline, torch_model, bacon_train_short, seed),
#             Config("sample_data/WhiskyConcentration", x_pipeline, y_pipeline, model_sklearn, None, seed),
